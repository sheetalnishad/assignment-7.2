#Data Analytics Assignment 7.2 - Session 7

# Q1 (a)Visualize the correlation between all variables in a meaningful and clear way 
# of representing. Find out top 3 reasons for having more crime in a city.

#Solution a:
# Use the data prepared in the assignment 13.1 
...
#-------------------------------------------------------------------------
# Q1 (b). What is the difference between co-variance and correlation? Take an 
